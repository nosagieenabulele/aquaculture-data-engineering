# etl/pipelines/weekly_check_pipeline.py
...
from etl.transform.weekly_check_transformer import WeeklyCheckTransformer
from etl.loaders.weekly_check_loader import WeeklyCheckLoader
...
class WeeklyCheckPipeline(ETLPipelineBase):
    ...
    def extract(self) -> pd.DataFrame | None:
        try:
            # Assuming worksheet index 8 contains Weekly Check data
